...
combinations_to_test = [
    # only pure_text
    ['pure_text_lem'],  # only BOW
    ['pure_text_unq_sw_vect'],  # only subword_vectors
    ['pure_text_lem', 'pure_text_unq_sw_vect'],  # BOW and subword_vectors

    # only text_data
    ['text_data_lem'],  # only BOW
    ['text_data_unq_sw_vect'],  # only subword_vectors
    ['text_data_lem', 'text_data_unq_sw_vect'],  # BOW and subword_vectors

    # text_data and Subject
    ['pure_text_lem', 'Subject_lem'],  # only BOW
    ['pure_text_unq_sw_vect', 'Subject_unq_sw_vect'],  # only subword_vectors
